...
namespace newres
{
    public partial class student_reg : System.Web.UI.Page
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            {
                fn_ConnectDB();
                string query = "INSERT INTO student(reg_no, first_name, last_name, gender, dob, email, phone, address, bloodgroup, birth_place, birth_district, pincode, password, programme_id, class_id, joining_year)" +
                               "VALUES(@reg_no, @first_name, @last_name, @gender, @dob, @email, @phone, @address, @bloodgroup, @birth_place, @birth_district, @pincode, @password, @programme_id, @class_id, @joining_year)";
